...
ProjectileMovement->Velocity = _DirectionVector;
발사체의 방향이 설정되지 않고 멈춰있는 문제가 발생했는데, 가장 먼저 Vector를 설정할 때 그냥 FRotat
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjEwNjgzNjg4LC01OTI3NzAzOThdfQ==
-->